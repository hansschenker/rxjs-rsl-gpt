...
| Deterministic YAML         | Restricted syntax parses and serializes canonically                               | RSL 07                 | scaffold |
| No YAML execution          | Parsing invokes no runtime reference                                              | RSL 07                 | scaffold |
